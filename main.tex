...
% \begin{align*}
% \Exp[\Regret_T(u)]
% & = \sum_{t=1}^T \langle r_t, u \rangle - \Exp\left[ \sum_{t=1}^T r_{t,I_t} \right] \\
% & = \Exp\left[\sum_{t=1}^T \langle \widetilde r_t, u \rangle \right] - \Exp\left[ \sum_{t=1}^T \langle \widetilde r_t, p_t \rangle \right] \\
% \end{align*}
